...
const GSPL_KEYWORDS = ['seed', 'gene', 'fn', 'type', 'trait', 'domain', 'import', 'export', 'let', 'if', 'else', 'match', 'case', 'return', 'for', 'in', 'while', 'breed', 'mutate', 'compose', 'evolve', 'grow', 'signed', 'where', 'true', 'false', 'nil'];
