...
const CONTRACT_IMPORTS: Record<string, () => Promise<unknown>> = {
  ...
  website: () => import('../src/lib/kernel/kernel/generators/website-contract'),
  world: () => import('../src/lib/kernel/generators/world-contract'),
  vehicle: () => import('../src/lib/kernel/generators/vehicle-contract'),
  furniture: () => import('../src/lib/kernel/generators/furniture-contract'),
  architecture: () => import('../src/lib/kernel/generators/architecture-contract'),
  fashion: () => import('../src/lib/kernel/generators/fashion-contract'),
  particle: () => import('../src/lib/kernel/generators/particle-contract'),
  shader: () => import('../src/lib/kernel/generators/shader-contract'),
  typography: () => import('../src/lib/kernel/generators/typography-contract'),
  audio: () => import('../src/lib/kernel/generators/audio-contract'),
  ecosystem: () => import('../src/lib/kernel/generators/ecosystem-contract'),
  game: () => import('../src/lib/kernel/generators/game-contract'),
  alife: () => import('../src/lib/kernel/generators/alife-contract'),
  shader: () => import('../src/lib/kernel/generators/shader-contract'),
  particle: () => import('../src/lib/kernel/generators/particle-contract'),
  procedural: () => import('../src/lib/kernel/generators/procedural-contract'),
  typography: () => import('../src/lib/kernel/generators/typography-contract'),
  architecture: () => import('../src/lib/kernel/generators/architecture-contract'),
  vehicle: () => import('../src/lib/kernel/generators/vehicle-contract'),
  furniture: () => import('../src/lib/kernel/generators/furniture-contract'),
  fashion: () => import('../src/lib/kernel/generators/fashion-contract'),
  choreography: () => import('../src/lib/kernel/generators/choreography-contract'),
  agent: () => import('../src/lib/kernel/generators/agent-contract'),
  physics: () => import('../src/lib/kernel/generators/physics-contract'),
  audio: () => import('../src/lib/kernel/generators/audio-contract'),
  ecosystem: () => import('../src/lib/kernel/generators/ecosystem-contract'),
  game: () => import('../src/lib/kernel/generators/game-contract'),
  alife: () => import('../src/lib/kernel/generators/alife-contract'),
  agent: () => import('../src/lib/kernel/generators/agent-contract'),
  physics: () => import('../src/lib/kernel/generators/physics-contract'),
  narrative: () => import('../src/lib/kernel/generators/narrative-contract'),
  ui: () => import('../src/lib/kernel/generators/ui-contract'),
  app: () => import('../src/lib/kernel/generators/app-contract'),
  field: () => import('../src/lib/kernel/generators/field-contract'),
  quantum: () => import('../src/lib/kernel/generators/quantum-contract'),
  cosmology: () => import('../src/lib/kernel/generators/cosmology-contract'),
  molecule: () => import('../src/lib/kernel/generators/molecule-contract'),
