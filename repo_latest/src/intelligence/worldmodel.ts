...
export class WorldModel {
  ...
  private initializeBaseConcepts(): void {
    const baseConcepts: Concept[] = [
      { id: 'seed', type: 'entity', name: 'Seed', properties: new Map([['arity', 'multi']]), relations: new Map() },
      { id: 'gene', type: 'component', name: 'Gene', properties: new Map([['arity', 'multi']]), relations: new Map() },
      { id: 'evolution', type: 'process', name: 'Evolution', properties: new Map([['arity', 'single']]), relations: new Map() },
      { id: 'mutation', type: 'operator', name: 'Mutation', properties: new Map([['arity', 'unary']]), relations: new Map() },
      { id: 'crossover', type: 'operator', name: 'Crossover', properties: new Map([['arity', 'binary']]), relations: new Map() },
      { id: 'fitness', type: 'metric', name: 'Fitness', properties: new Map([['arity', 'single']]), relations: new Map() },
      { id: 'genome', type: 'structure', name: 'Genome', properties: new Map([['arity', 'single']]), relations: new Map() },
      { id: 'phenotype', type: 'expression', name: 'Phenotype', properties: new Map([['arity', 'single']]), relations: new Map() },
      { id: 'breeding', type: 'process', name: 'Breeding', properties: new Map([['arity', 'binary']]), relations: new Map() },
      { id: 'selection', type: 'operator', name: 'Selection', properties: new Map([['arity', 'unary']]), relations: new Map() },
      { id: 'ga', type: 'algorithm', name: 'Genetic Algorithm', properties: new Map([['arity', 'population']]), relations: new Map() },
      { id: 'mapelites', type: 'algorithm', name: 'MAP-Elites', properties: new Map([['arity', 'grid']]), relations: new Map() },
      { id: 'cmaes', type: 'algorithm', name: 'CMA-ES', properties: new Map([['arity', ' continuous']]), relations: new Map() }
    ];
  ...
  infer(operation: string): string[] {
    ...
    for (const rel of this.relationships) {
      if (rel.type === operation) {
        inference.push(`${rel.from} ${operation} ${rel.to}`);
      }
    }
