...
import { registerSovereigntyRoutes } from './src/server/routes/sovereignty.js';
...
async function startServer() {
  ...
  // ── Sovereignty + GSPL export endpoints (modularized in WS17) ──
  registerSovereigntyRoutes(app, { optionalAuth, seeds });
