...
import { registerSeedSimilarRoutes } from './src/server/routes/seed-similar.js';
...
async function startServer() {
  ...
  registerSeedSimilarRoutes(app, { seeds, log, IntelligenceLayer, GENE_TYPES, distanceGene });
