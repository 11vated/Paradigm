...
export class Lexer {
  ...
  private readIdentifier(): void {
    ...
    const keyword = Object.keys(TokenType.Keywords).find(k => TokenType.Keywords[k as keyof typeof TokenType.Keywords] === value);
    
    if (keyword) {
      this.tokens.push({ type: value as TokenType, value, line: this.line, column: this.column - (this.pos - start) });
    } else if (value === 'true') {
