...
import { AlifeParams, AlifeResult, generateAlife } from './alife';
 ...
 */
export async function generateAlifeWorker(params: AlifeWorkerParams = defaultAlifeParams): Promise<AlifeResult> {
