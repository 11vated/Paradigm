...
// Generator imports
import { generateCharacter as generateCharacter } from '../generators/character';
...
export const DOMAIN_CONFIGS: DomainConfig[] = [
  ...
  },
  {
    domain: 'website',
    label: 'Website',
    description: 'Complete HTML/CSS/JS website from seed',
    viewportType: 'code',
    outputMimeTypes: ['text/html'],
  ...
  },
  {
    domain: 'field',
    label: 'Field',
    description: 'Field simulation with visualization',
    viewportType: '2d',
