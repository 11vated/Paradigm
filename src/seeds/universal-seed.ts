...
export class UniversalSeed {
  ...
  constructor(data?: Partial<UniversalSeed>) {
  ...
  setMetadata(key: keyof SeedMetadata, value: unknown): void {
...
export { SeedMetadata, SeedExpression, SeedDerivation, SerializedSeed };