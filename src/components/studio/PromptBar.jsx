    ...
    <div className="absolute bottom-4 left-4 right-4 z-20" data-testid="prompt-bar-container">
      <form onSubmit={handleSubmit} className="prompt-glow bg-[#0a0a0a] border border-neutral-700 flex items-center gap-2 px-4 py-2">
        ...
        <button
          ...
          className="px-4 py-1.5 bg-primary text-black font-bold text-[10px] uppercase tracking-wider hover:bg-primary/80 transition-colors disabled:opacity-30 disabled:cursor-not-allowed flex items-center gap-1.5"
        >
