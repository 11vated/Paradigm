      ...
      {seeds.length < 2 ? (
        ...
        <>
          ...
          <button
            ...
            className="w-full py-2 bg-cyan-500 text-black font-bold text-[10px] uppercase tracking-wider hover:bg-cyan-400 transition-colors disabled:opacity-30 flex items-center justify-center gap-2"
          >
